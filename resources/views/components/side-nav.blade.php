        ...
        <ul class="space-y-2 tracking-wide mt-8">
            <li>
                <a href="{{ route('dashboard') }}" aria-label="dashboard"
                    class="relative px-4 py-3 flex items-center space-x-4   rounded-md text-gray-600 group @if (request()->is('dashboard')) rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400 @endif">
            ...
            <li>
                <a href="{{ route('categories.edit') }}"
                    class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group @if (request()->is('categories')) rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400 @endif">
